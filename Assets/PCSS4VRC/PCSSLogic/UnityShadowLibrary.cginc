...
uniform float SimplePCSS_Softness = 0.015;
uniform float SimplePCSS_SoftnessFalloff = 1.0;
...
void SetValue()
{
    ...
    Softness = SimplePCSS_Softness;
    SoftnessFalloff = 1.0;
    //NearPlane = .1;

    Blocker_GradientBias = 0.0;
    PCF_GradientBias = 1.0;
    CascadeBlendDistance = .5;

    PenumbraWithMaxSamples = .15;
}
