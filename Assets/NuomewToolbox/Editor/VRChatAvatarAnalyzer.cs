...
namespace NyameauToolbox.Editor
{
    public class VRChatAvatarAnalyzer : EditorWindow
    {
        ...
        private void DrawHeader()
        {
            ...
            GUILayout.Label("VRChat模型参数统计 V1.0.8 By.诺喵", EditorStyles.centeredGreyMiniLabel);
        ...
        DrawParameterSection("Bits参数占用", analysisResult.bitsUsage,
            ...
            // 模型总纹理大小
            DrawParameterSection("模型总纹理大小", analysisResult.totalUncompressedSizeMB, 
         ...
         private void DrawTextureCompressionOptions()
         {
             ...
             if (useCompactMode)
             {
                 ...
                 for (int i = 0; i < textureCompressionList.Count; i++)
                 {
                     ...
                     int newMaxSize = EditorGUILayout.IntPopup(texInfo.newMaxSize, 
                         new string[] { "512", "800", "1K", "1280", "2K", "4K" },
                         new int[] { 512, 800, 1024, 1280, 2048, 4096 }, GUILayout.Width(50));
             ...
             else
             {
                 ...
                 for (int i = 0; i < textureCompressionList.Count; i++)
                 {
                     ...
                     int newMaxSize = EditorGUILayout.IntPopup(texInfo.newMaxSize, 
                         new string[] { "32", "64", "128", "256", "512", "800", "1024", "1280", "2048", "4096" },
                         new int[] { 32, 64, 128, 256, 512, 800, 1024, 1280, 2048, 4096 }, GUILayout.Width(120));
