// Unity built-in shader source. Modified to always render in front of other objects.
// Original Copyright (c) 2016 Unity Technologies. MIT license.

Shader "Particles/Standard Unlit_AlwaysFront"
{
    Properties
    {
    ...
    Category
    {
        ...
        {
            // ★常に最前面に表示する設定
            Tags { "Queue"="Overlay" "RenderType"="Transparent" "IgnoreProjector"="True" "PreviewType"="Plane" "PerformanceChecks"="False" }

            BlendOp [_BlendOp]
            Blend [_SrcBlend] [_DstBlend]
            ZWrite Off              // 深度書き込みを無効化
            ZTest Always            // 深度テストを常にパスさせる
            Cull [_Cull]
            ColorMask RGB
